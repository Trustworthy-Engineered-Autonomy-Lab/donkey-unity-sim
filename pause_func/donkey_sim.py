...
class DonkeyUnitySimContoller:
    ...
    # Pause Functionality Added by Kshitij Vejre
    def pause_env(self, is_pause) -> None:
        self.handler.send_pause_message(is_pause)
...
class DonkeyUnitySimHandler(IMesgHandler):
    ...
    def send_pause_message(self, is_pause) -> None:
        if is_pause:
            msg = {"msg_type": "pause", "is_pause": is_pause}
        else:
            msg = {"msg_type": "pause", "is_pause": is_pause}
